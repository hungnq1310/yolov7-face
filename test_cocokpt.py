"""Use for write bbox for prediction of model to eval AP and AR score"""
...
def detect(opt):
    ...
    testset_list = glob.glob(testset_folder + '/*.jpg', recursive=True)
    
    #TODO: Read annotation of cocowholebody dataset
    # get information of image, except bbox because need to predict it
    ...
    for image_path in tqdm(testset_list):
        ...
        pred = model(img, augment=opt.augment)['IKeypoint'][0]
        ...
        save_name = os.path.join(opt.save_folder, image_name + ".txt")
